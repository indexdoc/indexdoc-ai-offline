layui.define(['table', 'jquery', 'form'], function (exports) {
    ...
    tableSelect.prototype.render = function (opt) {
        ...
        opt.table.defaultSearchParams = opt.defaultSearchParams;
        elem.off('click').on('click', function(e) {
            ...
            form.on('submit(tableSelect_btn_search)', function(data){
                var _searchParams = {};
                if(opt.defaultSearchParams != undefined){
                    _searchParams = Object.assign(opt.defaultSearchParams == undefined?'':opt.defaultSearchParams,data.field);
                }else{
                    _searchParams = data.field;
                }
                tableSelect_table.reload({
                    where: {searchParams: JSON.stringify(_searchParams)},
                    page: {
                        curr: 1
                    }
                });
