layui.define(['form', 'jquery'], function(exports) { //提示：模块也可以依赖其它模块，如：layui.define('layer', callback);
    ...
    (function(r) {
        var J, K, L, M, N, O, v, t = {},
            ...
            y = [function(a) {
                ...
                b.bind(c.NODECREATED,
                    function(b, c, i) { h.apply(a.callback.onNodeCreated, [b, c, i]) });
                b.bind(c.CLICK, function(b, c, i, e, k) { h.apply(a.callback.onClick, [c, i, e, k]) });
                b.bind(c.EXPAND, function(b, c, i) { h.apply(a.callback.onExpand, [b, c, i]) });
                b.bind(c.COLLAPSE, function(b, c, i) { h.apply(a.callback.onCollapse, [b, c, i]) });
                b.bind(c.ASYNC_SUCCESS, function(b, c, i, e) { h.apply(a.callback.onAsyncSuccess, [b, c, i, e]) });
                b.bind(c.ASYNC_ERROR, function(b, c, i, e, k, g) { h.apply(a.callback.onAsyncError, [b, c, i, e, k, g]) });
                b.bind(c.REMOVE, function(b, c, i) {
                    h.apply(a.callback.onRemove, [b, c, i])
                });
                b.bind(c.SELECTED, function(b, c, i) { h.apply(a.callback.onSelected, [c, i]) });
                b.bind(c.UNSELECTED, function(b, c, i) { h.apply(a.callback.onUnSelected, [c, i]) })
            }],
            z = [function(a) {
                var b = g.event;
            ...
            B = [function(a, b, c, d, f, i) {
                if (c) {
                    ...
                    c.isFirstNode = f;
                    c.isLastNode = i;
                    c.getParentNode = function() { return e.getNodeCache(a, c.parentTId) };
                    c.getPreNode = function() { return e.getPreNode(a, c) };
                    c.getNextNode =
                        function() { return e.getNextNode(a, c) };
                    c.getIndex = function() { return e.getNodeIndex(a, c) };
                    c.getPath = function() { return e.getNodePath(a, c) };
                    c.isAjaxing = !1;
            ...
            H = [],
            e = {
                addNodeCache: function(a, b) { e.getCache(a).nodes[e.getNodeCacheId(b.tId)] = b },
                ...
                addInitProxy: function(a, b) { b ? u.splice(0, 0, a) : u.push(a) },
                ...
                getBeforeA: function(a,
                    b, c) { for (var d = 0, e = D.length; d < e; d++) D[d].apply(this, arguments) },
                ...
                getNodeIndex: function(a, b) {
                    if (!b) return null;
                    for (var c = b.parentTId ? b.getParentNode() : e.getRoot(a), c = e.nodeChildren(a, c), d = 0, f = c.length - 1; d <= f; d++)
                        if (c[d] === b) return d;
                    return -1
                },
                ...
                getNodeCache: function(a, b) { if (!b) return null; var c = x[a.treeId].nodes[e.getNodeCacheId(b)]; return c ? c : null },
                ...
                getPreNode: function(a, b) {
                    if (!b) return null;
                    for (var c = b.parentTId ? b.getParentNode() : e.getRoot(a), c = e.nodeChildren(a, c), d = 0, f = c.length; d < f; d++)
                        if (c[d] === b) return d ==
                            0 ? null : c[d - 1];
                    return null
                },
                ...
                nodeTitle: function(a,
                    b) { return "" + b[a.data.key.title === "" ? a.data.key.name : a.data.key.title] },
                ...
                removeSelectedNode: function(a, b) {
                    for (var c = e.getRoot(a), d = 0, f = c.curSelectedList.length; d < f; d++)
                        if (b === c.curSelectedList[d] || !e.getNodeCache(a, c.curSelectedList[d].tId)) c.curSelectedList.splice(d, 1), a.treeObj.trigger(g.event.UNSELECTED, [a.treeId, b]), d--, f--
                },
                setCache: function(a,
                    b) { x[a.treeId] = b },
            ...
            n = {
                bindEvent: function(a) { for (var b = 0, c = y.length; b < c; b++) y[b].apply(this, arguments) },
                ...
                unbindTree: function(a) { a.treeObj.unbind("selectstart", v).unbind("click", n.proxy).unbind("dblclick", n.proxy).unbind("mouseover", n.proxy).unbind("mouseout", n.proxy).unbind("mousedown", n.proxy).unbind("mouseup", n.proxy).unbind("contextmenu", n.proxy) },
                doProxy: function(a) {
        ...
        v = function(a) { a = a.originalEvent.srcElement.nodeName.toLowerCase(); return a === "input" || a === "textarea" };
        var h = {
                apply: function(a, b, c) { return typeof a == "function" ? a.apply(Q, b ? b : []) : c },
                ...
                $: function(a,
                    b, c) { b && typeof b != "string" && (c = b, b = ""); return typeof a == "string" ? r(a, c ? c.treeObj.get(0).ownerDocument : null) : r("#" + a.tId + b, c ? c.treeObj : null) },
            ...
            j = {
                    ...
                    r.ajax({
                        ...
                        success: function(i) {
                            if (s ==
                                e.getRoot(a)._ver) {
                                var f = [];
                                try { f = !i || i.length == 0 ? [] : typeof i == "string" ? eval("(" + i + ")") : i } catch (k) { f = i }
                ...
                cancelPreSelectedNode: function(a, b, c) {
                    ...
                    for (f = d.length - 1; f >= 0; f--)
                        if (i = d[f], b === i || !b && (!c || c !== i))
                            if (l(i, g.id.A, a).removeClass(g.node.CURSELECTED), b) { e.removeSelectedNode(a, b); break } else d.splice(f, 1), a.treeObj.trigger(g.event.UNSELECTED, [a.treeId, i])
                },
                ...
                destroy: function(a) { a && (e.initCache(a), e.initRoot(a), n.unbindTree(a), n.unbindEvent(a), a.treeObj.empty(), delete t[a.treeId]) },
                ...
                makeUlLineClass: function(a, b) { return a.view.showLine && !b.isLastNode ? g.line.LINE : "" },
                    ...
                    if (b)
                        if (typeof Element === "undefined") {
                            ...
                            if (!Element.prototype.scrollIntoViewIfNeeded) Element.prototype.scrollIntoViewIfNeeded = function(a) {
                                function b(a, c) { return { start: a, length: c, end: a + c } }

                                function c(b, d) { return !1 === a || d.start < b.end && b.start < d.end ? Math.max(b.end - d.length, Math.min(d.start, b.start)) : (b.start + b.end - d.length) / 2 }

                                function d(a, b) { return { x: a, y: b, translate: function(c, i) { return d(a + c, b + i) } } }
                ...
                setFirstNode: function(a, b) { var c = e.nodeChildren(a, b); if (c.length > 0) c[0].isFirstNode = !0 },
                ...
                removeNode: function(a, b) {
                    ...
                    b.isFirstNode = !1;
                    b.isLastNode = !1;
                    b.getPreNode = function() { return null };
                    b.getNextNode = function() { return null };
                    if (e.getNodeCache(a, b.tId)) {
                        l(b, a).remove();
                        e.removeNodeCache(a, b);
                        e.removeSelectedNode(a, b);
                        for (var f = e.nodeChildren(a, d), i = 0, h = f.length; i < h; i++)
                            if (f[i].tId == b.tId) { f.splice(i, 1); break }
                        j.setFirstNode(a, d);
                        j.setLastNode(a, d);
                        var k, i = f.length;
                        if (!a.data.keep.parent && i ==
                            0) e.nodeIsParent(a, d, !1), d.open = !1, delete d[a.data.key.children], i = l(d, g.id.UL, a), h = l(d, g.id.SWITCH, a), k = l(d, g.id.ICON, a), j.replaceSwitchClass(d, h, g.folder.DOCU), j.replaceIcoClass(d, k, g.folder.DOCU), i.css("display", "none");
                ...
                switchNode: function(a, b) { b.open || !h.canAsync(a, b) ? j.expandCollapseNode(a, b, !b.open) : a.async.enable ? j.asyncNode(a, b) || j.expandCollapseNode(a, b, !b.open) : b && j.expandCollapseNode(a, b, !b.open) }
            };
        r.fn.zTree = {
            consts: {
            ...
            init: function(a, b, c) {
                ...
                var f = {
                    ...
                    addNodes: function(a, b, c, f) {
                        function g() { j.addNodes(d, a, b, n, f == !0) }
                        a || (a = null);
                    ...
                    cancelSelectedNode: function(a) { j.cancelPreSelectedNode(d, a) },
                    ...
                    getSelectedNodes: function() { for (var a = [], b = e.getRoot(d).curSelectedList, c = 0, f = b.length; c < f; c++) a.push(b[c]); return a },
                    isSelectedNode: function(a) { return e.isSelectedNode(d, a) },
                    reAsyncChildNodesPromise: function(a, b, c) { return new Promise(function(d, e) { try { f.reAsyncChildNodes(a, b, c, function() { d(a) }) } catch (g) { e(g) } }) },
                    ...
                    selectNode: function(a,
                        ...
                        if (a && h.uCanDo(d)) {
                            ...
                            else if (!c) try { l(a, d).focus().blur() } catch (f) {}
                            j.selectNode(d, a, b)
                        }
                    },
    ...
    (function(n) {
        ...
        n.extend(!0, n.fn.zTree._z, {
            ...
            view: {
                ...
                setChkClass: function(c, a, b) { a && (b.nocheck === !0 ? a.hide() : a.show(), a.attr("class", f.makeChkClass(c, b))) },
                    ...
                    if (a.parentTId) {
                        ...
                        if (!b)
                            for (var g = e.nodeChildren(c, a.getParentNode()), k = 0, o = g.length; k < o; k++) {
                                var l = g[k],
                                    i = e.nodeChecked(c, l);
                                if (l.nocheck !== !0 && l.chkDisabled !== !0 && i || (l.nocheck === !0 || l.chkDisabled === !0) && l.check_Child_State > 0) { j = !1; break }
                            }
                ...
                setSonNodeCheckBox: function(c, a, b, d) {
                    if (a) {
                        ...
                        if (a != e.getRoot(c) && a.chkDisabled !== !0) {
                            ...
                            if (a.nocheck !== !0 && a.chkDisabled !== !0) { if (e.nodeChecked(c, a, b), !g) a.check_Child_State = k && k.length > 0 ? b ? 2 : 0 : -1 } else a.check_Child_State = -1;
                            f.setChkClass(c, j, a);
            ...
            data: {
                ...
                getCheckStatus: function(c, a) { if (!c.check.enable || a.nocheck || a.chkDisabled) return null; var b = e.nodeChecked(c, a); return { checked: b, half: a.halfCheck ? a.halfCheck : c.check.chkStyle == h.radio.STYLE ? a.check_Child_State === 2 : b ? a.check_Child_State > -1 && a.check_Child_State < 2 : a.check_Child_State > 0 } },
                        ...
                        if (d)
                            for (var j = 0, g = d.length; j < g; j++) {
                                ...
                                if (c.check.chkStyle == h.radio.STYLE)
                                    if (l = f.nocheck === !0 || f.chkDisabled === !0 ? f.check_Child_State : f.halfCheck === !0 ? 2 : i ? 2 : f.check_Child_State > 0 ? 2 : 0, l == 2) { b = 2; break } else l == 0 && (b = 0);
        ...
        e.addInitUnBind(function(c) { c.treeObj.unbind(h.event.CHECK) });
        ...
        e.addInitNode(function(c, a, b, d) {
            if (b) {
                ...
                b.check_Focus = !1;
                b.getCheckStatus = function() { return e.getCheckStatus(c, b) };
        ...
        e.addInitProxy(function(c) {
            var a = c.target,
                ...
                g = "",
                k = null;
            if (i.eqs(c.type, "mouseover")) { if (b.check.enable && i.eqs(a.tagName, "span") && a.getAttribute("treeNode" + h.id.CHECK) !== null) d = i.getNodeMainDom(a).id, g = "mouseoverCheck" } else if (i.eqs(c.type, "mouseout")) {
                if (b.check.enable &&
        ...
        e.addInitRoot(function(c) { e.getRoot(c).radioCheckedList = [] });
        e.addBeforeA(function(c, a, b) { c.check.enable && (e.makeChkFlag(c, a), b.push("<span ID='", a.tId, h.id.CHECK, "' class='", f.makeChkClass(c, a), "' treeNode", h.id.CHECK, a.nocheck === !0 ? " style='display:none;'" : "", "></span>")) });
        e.addZTreeTools(function(c, a) {
            ...
            a.checkAllNodes = function(a) { f.repairAllChk(this.setting, !!a) };
            a.getCheckedNodes = function(a) {
                var a = a !== !1,
                    b = e.nodeChildren(c, e.getRoot(this.setting));
                return e.getTreeCheckedNodes(this.setting, b, a)
            };
            a.getChangeCheckedNodes = function() { var a = e.nodeChildren(c, e.getRoot(this.setting)); return e.getTreeChangeCheckedNodes(this.setting, a) };
    ...
    (function(B) {
                ...
                onMousedownNode: function(a, b) {
                    function c(a) {
                        ...
                        if (m.dragFlag == 0) {
                            ...
                            if (n.length > 1) {
                                ...
                                for (b = 0, c = o.length; b < c; b++)
                                    if (m.dragNodeShowBefore[o[b].tId] !== void 0 && (j && p > -1 && p + 1 !== b && (j = !1), g.push(o[b]), p = b), n.length === g.length) { n = g; break }
                            }
                        ...
                        if (m.dragFlag == 1) {
                            ...
                            if (a.target && k.isChildOrSelf(a.target, h.treeId)) {
                                ...
                                var R = !0;
                                for (b = 0, c = n.length; b < c; b++)
                                    if (g = n[b], D.id === g.tId) { R = !1; break } else if (q(g, f).find("#" + D.id).length > 0) { R = !1; break }
                    ...
                    if (i.isSelectedNode(f, b))
                        for (o = 0, j = s.length; o < j; o++) {
                            ...
                            n.push(s[o]);
                            if (n[0].parentTId !== s[o].parentTId) { n = [b]; break }
                        } else n = [b];
                    e.editNodeBlur = !0;
        ...
        B.extend(!0, B.fn.zTree._z, {
            ...
            view: {
                ...
                editNode: function(a, b) {
                    var c = i.getRoot(a);
                    e.editNodeBlur = !1;
                    if (i.isSelectedNode(a, b) && c.curEditNode == b && b.editNameFlag) setTimeout(function() { k.inputFocus(c.curEditInput) }, 0);
                    else {
                        b.editNameFlag = !0;
                        e.removeTreeDom(a, b);
                        ...
                        l.bind("blur", function() { e.editNodeBlur || e.cancelCurEditNode(a) }).bind("keydown", function(b) { b.keyCode == "13" ? (e.editNodeBlur = !0, e.cancelCurEditNode(a)) : b.keyCode == "27" && e.cancelCurEditNode(a, null, !0) }).bind("click", function() { return !1 }).bind("dblclick", function() { return !1 });
                ...
                moveNode: function(a, b, c, l, g, k) {
                    ...
                    if (b != c && (!a.data.keep.leaf || !b || i.nodeIsParent(a, b) || l != d.move.TYPE_INNER)) {
                        ...
                        if (c.isFirstNode) { if (y = 0, v.length > 1) n = v[1], n.isFirstNode = !0 } else if (c.isLastNode) y = v.length - 1, n = v[y - 1], n.isLastNode = !0;
                        else
                            for (j = 0, s = v.length; j < s; j++)
                                if (v[j].tId == c.tId) { y = j; break }
                        y >= 0 && v.splice(y, 1);
                        if (l != d.move.TYPE_INNER)
        ...
        i.addInitBind(function(a) {
            var b = a.treeObj,
                c = d.event;
            b.bind(c.RENAME, function(b, c, d, e) { k.apply(a.callback.onRename, [b, c, d, e]) });
            b.bind(c.DRAG, function(b, c, d, e) { k.apply(a.callback.onDrag, [c, d, e]) });
            b.bind(c.DRAGMOVE, function(b,
                c, d, e) { k.apply(a.callback.onDragMove, [c, d, e]) });
            b.bind(c.DROP, function(b, c, d, e, f, i, q) { k.apply(a.callback.onDrop, [c, d, e, f, i, q]) })
        });
        ...
        i.addInitNode(function(a, b, c) { if (c) c.isHover = !1, c.editNameFlag = !1 });
        i.addInitProxy(function(a) {
            ...
            } else if (k.eqs(a.type, "mouseout")) m = k.getMDom(c, e, [{ tagName: "a", attrName: "treeNode" + d.id.A }]), m || (g = "remove", j = "hoverOutNode");
            else if (k.eqs(a.type, "mousedown") && (m = k.getMDom(c, b, [{ tagName: "a", attrName: "treeNode" + d.id.A }]))) g = k.getNodeMainDom(m).id, j = "mousedownNode";
        ...
        i.addZTreeTools(function(a, b) {
            b.cancelEditName = function(a) { i.getRoot(this.setting).curEditNode && e.cancelCurEditNode(this.setting, a ? a : null, !0) };
            b.copyNode = function(b,
                ...
                g == d.move.TYPE_INNER ? (l = function() { e.addNodes(f.setting, b, -1, [m], o) }, k.canAsync(this.setting, b) ? e.asyncNode(this.setting, b, o, l) : l()) : (e.addNodes(this.setting, b.parentNode, -1, [m], o), e.moveNode(this.setting, b, m, g, !1, o));
                return m
            };
            ...
            b.moveNode = function(b, l, g, o) {
                function j() { e.moveNode(m.setting, b, l, g, !1, o) }
                if (!l) return l;
        ...
        var V = e.makeNodeUrl;
        e.makeNodeUrl = function(a, b) { return a.edit.enable ? null : V.apply(e, arguments) };
        var K = e.removeNode;
        e.removeNode =
            function(a, b) {
                var c = i.getRoot(a);
    ...
    (function(j) {
            ...
            view: {
                ...
                setFirstNodeForShow: function(c, a) {
                    ...
                    for (f = 0, g = a.length; f < g; f++) {
                        ...
                        if (!i && !j && b.isFirstNode) { i = b; break } else if (!i && !j && !b.isFirstNode) b.isFirstNode = !0, i = b, e.setNodeLineIcos(c, b);
                ...
                setLastNodeForShow: function(c,
                    ...
                    for (f = a.length - 1; f >= 0; f--) {
                        ...
                        if (!g && !h && b.isLastNode) { g = b; break } else if (!g && !h && !b.isLastNode) b.isLastNode = !0, g = b, e.setNodeLineIcos(c, b);
        ...
        d.addZTreeTools(function(c, a) {
            a.showNodes = function(a, b) { e.showNodes(c, a, b) };
            a.showNode = function(a, b) { a && e.showNodes(c, [a], b) };
            a.hideNodes = function(a, b) { e.hideNodes(c, a, b) };
            a.hideNode = function(a, b) { a && e.hideNodes(c, [a], b) };
            var b = a.checkNode;
        ...
        if (p) d.getTreeCheckedNodes = function(c, a, b, f) { if (a && a.length > 0) { var e = a[0].getParentNode(); if (e && d.isHidden(c, e)) return [] } return p.apply(d, arguments) };
        var q = d.getTreeChangeCheckedNodes;
        if (q) d.getTreeChangeCheckedNodes = function(c, a, b) { if (a && a.length > 0) { var e = a[0].getParentNode(); if (e && d.isHidden(c, e)) return [] } return q.apply(d, arguments) };
