...
//                                    $(".layui-left-nav-tree").attr('class', 'layui-nav layui-nav-tree layui-left-nav-tree layui-hide');
                                ...
                                if ($element.attr('class') != 'layui-nav-item layui-nav-itemed') {
                                    ...
                                    $(".layui-header-menu li").attr('class', 'layui-nav-item');
                                    $("#" + moduleId + "HeaderId").addClass("layui-this");
                                    $(".layui-left-nav-tree").attr('class', 'layui-nav layui-nav-tree layui-left-nav-tree');
                                    $("#" + moduleId).attr('class', 'layui-nav layui-nav-tree layui-left-nav-tree layui-this');
                                }
                            }
                        };
                        ...
                        for (var i = pageHeader.length - 2; i >= 0; i--) {
...
//                    leftMenuHtml += '<ul class="layui-nav layui-nav-tree layui-left-nav-tree ' + '" id="' + key + '">\n';
                    index = key;
                    menu = val;
